...
formed everytime there a new incoming frame is read
*/
...
public:
   ...
   // frame(Mat imagecap, int input_frameId);
    ...
    float* deptharrptr[util::MAX_PYRAMID_LEVEL];
    ...
    float* depthvararrptr[util::MAX_PYRAMID_LEVEL];
    */  
